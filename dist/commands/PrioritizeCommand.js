...
var __1 = require("..");
function PrioritizeCommand(service) {
    return node_brigadier_1.literal('prioritize')
        .then(node_brigadier_1.argument('Player', node_brigadier_1.word())
...
//# sourceMappingURL=PrioritizeCommand.js.map